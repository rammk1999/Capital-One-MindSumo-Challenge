...
class DispatchUnitPredictor:
    def __init__(self, data="./data/sfpd_filtered_for_predictions.csv", neighbors=9):
    ...
    def predict_dispatch(self, user_latitude, user_longitude, user_time):
        ...
        input_time = datetime.timedelta(hours=input_time.tm_hour % 24, minutes=input_time.tm_min % 60,
                                        seconds=input_time.tm_sec % 60).total_seconds()
